...
In the future we hope that mtree will be deprecated in favor of a
hier package or a single MTREE that won't be customizable in per
...
in the pkg(8) code make assumptions about OS specific behavior.  If
