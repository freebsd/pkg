...
pkg_config_defaults_body()
{
	atf_check \
	    ...
	    -o match:'^ *VULNXML_SITE = "https://raw.githubusercontent.com/illuusio/vuln-test/refs/heads/main/db/freebsd-osv.json";$' \
	    -o match:'^ *OSVF_SITE = "https://raw.githubusercontent.com/illuusio/vuln-test/refs/heads/main/db/freebsd-osv.json";$' \
